...
@section('content')
  <div class="container">
						...
						<div class="row">
							...
							<div class="col-xl-12">
								<ul class="breadcrumb">
									...
									<li class="breadcrumb-item active">Thai 3D Dashboard</li>
								</ul>

								<h1 class="page-header">
									Thai 3D Dashboard <small>page header description goes here...</small>
								</h1>
								...
								<div id="datatable" class="mb-5">
									<h4><a href="{{ route('admin.lotteries.create') }}" class="btn btn-primary">New Thai 3D Ticket Create</a></h4>
									<p></p>
									<div class="card">
										<div class="card-body">
          ...
          <tbody>
              ...
              @if($lottery->category->category_name === 'Thai_3D')
              <tr>
														<td>{{ ++$key }}</td>
